...
**
** Created: Sun May 10 23:05:08 2020
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QrCode_t, stringdata) + ofs \
...
const QMetaObject QrCode::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QrCode.data,
      qt_meta_data_QrCode,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QrCode.stringdata))
        return static_cast<void*>(const_cast< QrCode*>(this));
